...
public class SumOfGivenRange {
	...
	/*
	 * A recursive function to get the sum of values in the given range of the
	...
	static void updateValue(int arr[], int st[], int n, int i, int new_val) {
		...
		if (i < 0 || i > n - 1) {
			System.out.println("Invalid Update Value Index");
			return;
		}
	 ...
	 * range. The following are parameters st, si, ss and se are same as getSumUtil() 
	...
	public static void main(String[] args) {
		...
		System.out.println(getSum(st, arr.length, 1, 3));
